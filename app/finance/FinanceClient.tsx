...
export default function FinanceClient() {
    ...
    const balance = session?.user?.cash ?? 0
    ...
    return (
        <div className="h-full w-full flex justify-center pt-24 pb-12 px-4">
            <div className="w-full max-w-sm flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2">
                    <button
                        onClick={() => { setAmountInput(""); setError(""); setView("deposit-amount") }}
                        className="bg-secondary rounded-sm px-5 py-4 flex items-center gap-4 text-left button transition-colors w-full"
                    >
                        <div className="w-9 h-9 rounded-sm bg-special/20 flex items-center justify-center shrink-0 text-special text-xl">
                            ↓
                        </div>
                    ...
                    <button
                        onClick={() => { setAmountInput(""); setError(""); setView("withdraw") }}
                        className="bg-secondary rounded-sm px-5 py-4 flex items-center gap-4 text-left button transition-colors w-full"
                    >
                        <div className="w-9 h-9 rounded-sm bg-accent flex items-center justify-center shrink-0 text-lg">
                            ↑
                        </div>
                        <div className="flex flex-col gap-0.5">
